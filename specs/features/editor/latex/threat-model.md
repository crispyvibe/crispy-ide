...
### F055-T01: Network exfiltration / phone-home by rendered content
...
### F055-T02: `file://` read-access widening / local file disclosure
...
### F055-T03: JS injection via `evaluateJavaScript`
...
### F055-T04: Malicious `.tex` / markdown content (render abuse)
...
### F055-T05: CSP weakness in the markdown runtime (`'unsafe-eval'`, inert `file:`)
...
### F055-T06: Inert style/font `file:` allowance abused for tracking
...
### F055-T07: Lossy / destructive round-trip (data integrity)
...
### F055-T08: External-link / cross-origin navigation escape
...
### F055-T09: Supply-chain tampering of the vendored KaTeX
